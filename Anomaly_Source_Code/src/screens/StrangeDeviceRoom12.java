...
public class StrangeDeviceRoom12 implements Screen {
	...
	public Screen respondToUserInput(KeyEvent key) {
		...
		case KeyEvent.VK_R:
			PlayScreen2.death = 0;
			return key.getKeyCode() == KeyEvent.VK_R ? new PlayScreen2() : this;
	}
		return key.getKeyCode() == KeyEvent.VK_Q ? new Room12ComeBack() : this;	
	}
}
