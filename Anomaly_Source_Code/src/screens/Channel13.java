...
public class Channel13 implements Screen {
	...
	public void displayOutput(AsciiPanel terminal) {
		...
		terminal.write("This is your Emergency Channel, Please stand-by for instructions.",1,1);
		...
		terminal.write("-- Press [e] to change to the initial channel --",1,12);
	...
	public Screen respondToUserInput(KeyEvent key) {
		...
		case KeyEvent.VK_W:
	        ...
	        if(ExaminateTV12.y == 3) {
	        	if(ExaminateTV12.p == 2) {
	        		return key.getKeyCode() == KeyEvent.VK_W ? new ChannelWin() : this;
	        	} else if(ExaminateTV12.p < 2) {
