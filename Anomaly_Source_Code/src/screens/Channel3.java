...
public class Channel3 implements Screen {
	...
	public void displayOutput(AsciiPanel terminal) {
		...
		terminal.write("The channel is displaying images of Washington, D.C.",1,1);
		terminal.write("You can change the channel",1,2);
		terminal.write("-- Press [q] to change to the initial channel --",1,10);
