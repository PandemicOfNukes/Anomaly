...
public class ExaminateVials implements Screen {
	...
	public void displayOutput(AsciiPanel terminal) {
		...
		terminal.write("In the table you see several vials containing liquids...",1,1);
		terminal.write("1- NitriPocs",1,2);
		terminal.write("2- PotresNi",1,3);
		terminal.write("3- OlgaAcid",1,4);
		terminal.write("4- NitriAcidConlignus",1,5);
		terminal.write("5- Petrioc",1,6);
		terminal.write("6- NitriColgavika",1,7);
		...
		terminal.write("-- Press [y] to add NitriColgavika --",1,14);
		terminal.write("-- Press [u] to go back --",1,15);
	}
