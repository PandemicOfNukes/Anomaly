...
public class AddNitriAcidConlignus implements Screen {
	File Clip = new File("Pouring.WAV");
	static Clip clip2;
	static boolean nitricacidconlignus = false; 
	...
	public void displayOutput(AsciiPanel terminal) {
		...
		nitricacidconlignus = true;
		terminal.write("You added NitricAcidConlignus",1,1);
