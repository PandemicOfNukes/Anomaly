...
public class ControlCenter13Computer implements Screen {
	...
	public void displayOutput(AsciiPanel terminal) {
		...
		terminal.write("-- Press [q] to read Conversation-Log1 --",1,11);
		terminal.write("-- Press [w] to read Conversation-Log4 --",1,12);
	...
	public Screen respondToUserInput(KeyEvent key) {
		...
		case KeyEvent.VK_Q:
			return key.getKeyCode() == KeyEvent.VK_Q ? new ConversationLog12() : this;
		case KeyEvent.VK_W:
			return key.getKeyCode() == KeyEvent.VK_W ? new ConversationLog4() : this;
	}
