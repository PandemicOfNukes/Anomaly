...
public class ControlCenter21ComeBack implements Screen {
	...
	public Screen respondToUserInput(KeyEvent key) {
		...
		case KeyEvent.VK_W:
			return key.getKeyCode() == KeyEvent.VK_W ? new Room41() : this;
		}
		return key.getKeyCode() == KeyEvent.VK_E ? new Cafeteria12ComeBack() : this;
	}
}
