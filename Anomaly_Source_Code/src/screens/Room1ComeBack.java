...
public class Room1ComeBack implements Screen {
	@Override
	...
	public Screen respondToUserInput(KeyEvent key) {
		switch(key.getKeyCode()) {
			case KeyEvent.VK_Q:
				return key.getKeyCode() == KeyEvent.VK_Q ? new ExaminateToiletRoom1() : this;
			case KeyEvent.VK_W:
				return key.getKeyCode() == KeyEvent.VK_W ? new StrangeDeviceRoom1() : this;
		}
			return key.getKeyCode() == KeyEvent.VK_E ? new ControlCenter1() : this;
	}
}
