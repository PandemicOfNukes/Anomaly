...
public class StrangeDeviceRoom43 implements Screen {
	...
	public Screen respondToUserInput(KeyEvent key) {
		...
		case KeyEvent.VK_R:
			PlayScreen4.death = 0;
			return key.getKeyCode() == KeyEvent.VK_R ? new PlayscreenAnomaly3() : this;
	}
		    return key.getKeyCode() == KeyEvent.VK_Q ? new Room43ComeBack() : this;	
	}
}
