...
public class ControlCenter23ComeBack implements Screen {
	...
	public Screen respondToUserInput(KeyEvent key) {
		...
		case KeyEvent.VK_W:
			return key.getKeyCode() == KeyEvent.VK_W ? new Room43() : this;
		}
		return key.getKeyCode() == KeyEvent.VK_E ? new Cafeteria14ComeBack() : this;
	}
}
