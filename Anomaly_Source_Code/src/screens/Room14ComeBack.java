...
public class Room14ComeBack implements Screen {
	...
	public Screen respondToUserInput(KeyEvent key) {
		...
		case KeyEvent.VK_Q:
			return key.getKeyCode() == KeyEvent.VK_Q ? new Room14Writting() : this;
		case KeyEvent.VK_W:
			return key.getKeyCode() == KeyEvent.VK_W ? new ExaminateToiletRoom14() : this;
		case KeyEvent.VK_E:
			return key.getKeyCode() == KeyEvent.VK_E ? new StrangeDeviceRoom14() : this;
	}
		return key.getKeyCode() == KeyEvent.VK_R ? new ControlCenter14() : this;
	}
