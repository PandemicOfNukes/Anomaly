...
public class StrangeDeviceRoom42 implements Screen {
	...
	public Screen respondToUserInput(KeyEvent key) {
		...
		case KeyEvent.VK_R:
			PlayScreen3.death = 0;
			return key.getKeyCode() == KeyEvent.VK_R ? new PlayscreenAnomaly2() : this;
	}
		    return key.getKeyCode() == KeyEvent.VK_Q ? new Room42ComeBack() : this;	
	}
}
