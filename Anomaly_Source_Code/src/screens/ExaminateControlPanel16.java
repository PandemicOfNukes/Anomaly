...
public class ExaminateControlPanel16 implements Screen {
	...
	public void displayOutput(AsciiPanel terminal) {
		...
		terminal.write("I need to input a number to the code...",1,5);
	...
	public Screen respondToUserInput(KeyEvent key) {
		...
		return key.getKeyCode() == KeyEvent.VK_A ? new Cafeteria16ComeBack() : this;
	}
}