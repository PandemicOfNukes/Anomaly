...
public class ControlCenter14ComeBack implements Screen {

	@Override
	public void displayOutput(AsciiPanel terminal) {
		System.out.println(this);

		terminal.write("You are in the control room.",1,1);
	...
	public Screen respondToUserInput(KeyEvent key) {
		...
		case KeyEvent.VK_W:
			return key.getKeyCode() == KeyEvent.VK_W ? new ControlCenter14FileCabinet() : this;
		case KeyEvent.VK_R:
			return key.getKeyCode() == KeyEvent.VK_R ? new Room14ComeBack(): this;
		}
		return key.getKeyCode() == KeyEvent.VK_E ? new Corridor14() : this;
	}
