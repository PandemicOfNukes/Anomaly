...
public class Corridor15ComeBack implements Screen {
	...
	public Screen respondToUserInput(KeyEvent key) {
		...
		case KeyEvent.VK_Q:
			return key.getKeyCode() == KeyEvent.VK_Q ? new Corridor15Left() : this;
		case KeyEvent.VK_W:
			return key.getKeyCode() == KeyEvent.VK_W ? new Corridor15Right() : this;
		case KeyEvent.VK_E:
			return key.getKeyCode() == KeyEvent.VK_E ? new Cafeteria15() : this;	
		}
		return key.getKeyCode() == KeyEvent.VK_R ? new ControlCenter15ComeBack() : this;	
	}
}
