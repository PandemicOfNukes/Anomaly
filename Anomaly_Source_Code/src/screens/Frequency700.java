...
public class Frequency700 implements Screen {
	...
	public void displayOutput(AsciiPanel terminal) {
		...
		terminal.write("The frequency is 700 FM",1,1);
		terminal.write("Theres people roaming the streets attacking other people...",1,2);
		terminal.write("-- Press [q] to change to 400 FM --",1,10);
		terminal.write("-- Press [w] to change to 600 FM --",1,11);
		terminal.write("-- Press [e] to change to the initial frequency --",1,12);
