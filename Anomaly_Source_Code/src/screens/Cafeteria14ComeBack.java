...
public class Cafeteria14ComeBack implements Screen {
	...
	public void displayOutput(AsciiPanel terminal) {
		...
		terminal.write("They are all locked... Except Control Center 2 and the Laboratory",1,8);
		...
		terminal.write("-- Press [w] to go to the Laboratory --",1,17);
	...
	public Screen respondToUserInput(KeyEvent key) {
		...
		case KeyEvent.VK_Q:
			return key.getKeyCode() == KeyEvent.VK_Q ? new ExaminateTables14() : this;
		case KeyEvent.VK_W:
			return key.getKeyCode() == KeyEvent.VK_W ? new Laboratory1() : this;
		case KeyEvent.VK_E:
			return key.getKeyCode() == KeyEvent.VK_E ? new ExaminateControlPanel14() : this;
		case KeyEvent.VK_R:
			return key.getKeyCode() == KeyEvent.VK_R ? new ControlCenter23() : this;
		}
		return key.getKeyCode() == KeyEvent.VK_T ? new Corridor14ComeBack() : this;
	}
}