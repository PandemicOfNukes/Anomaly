...
public class ControlCenter15FileCabinet implements Screen {
	...
	public void displayOutput(AsciiPanel terminal) {
		...
		terminal.write("Mandatory Evacuation,1980",1,6);
		...
		terminal.write("-- Press [r] to read 'Mandatory Evacuation' --",1,13);
	...
	public Screen respondToUserInput(KeyEvent key) {
		...
		case KeyEvent.VK_Q:
			return key.getKeyCode() == KeyEvent.VK_Q ? new DreamGameLabsBuilding4() : this;
		case KeyEvent.VK_W:
			return key.getKeyCode() == KeyEvent.VK_W ? new StrangeArchiteture3() : this;
		case KeyEvent.VK_E:
			return key.getKeyCode() == KeyEvent.VK_E ? new MemoGossip2() : this;
		case KeyEvent.VK_R:
			return key.getKeyCode() == KeyEvent.VK_R ? new MandatoryEvacuation() : this;
		}
