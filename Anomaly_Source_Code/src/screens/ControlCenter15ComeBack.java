...
public class ControlCenter15ComeBack implements Screen {
	...
	public Screen respondToUserInput(KeyEvent key) {
		...
		case KeyEvent.VK_W:
			return key.getKeyCode() == KeyEvent.VK_W ? new ControlCenter15FileCabinet() : this;
		case KeyEvent.VK_R:
			return key.getKeyCode() == KeyEvent.VK_R ? new Room15ComeBack(): this;
		}
		return key.getKeyCode() == KeyEvent.VK_E ? new Corridor15() : this;
	}
