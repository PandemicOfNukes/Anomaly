...
public class Corridor15Map5 implements Screen {
	...
	public void displayOutput(AsciiPanel terminal) {
		...
		terminal.write("There is a blood splatered in the map...",1,5);
		terminal.write("-- Press [q] to go back --",1,10);		
	}

	@Override
	public Screen respondToUserInput(KeyEvent key) {
		return key.getKeyCode() == KeyEvent.VK_Q ? new Corridor15Right() : this;
	}
