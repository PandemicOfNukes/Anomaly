...
public class Room42 implements Screen {
	@Override
	public void displayOutput(AsciiPanel terminal) {
		System.out.println(this);

		terminal.write("You enter in the lab rat 4 room.",1, 1);
	...
	public Screen respondToUserInput(KeyEvent key) {
		switch(key.getKeyCode()) {
			case KeyEvent.VK_Q:
				return key.getKeyCode() == KeyEvent.VK_Q ? new ExaminateToiletRoom42() : this;
			case KeyEvent.VK_W:
				return key.getKeyCode() == KeyEvent.VK_W ? new StrangeDeviceRoom42() : this;
		}
			return key.getKeyCode() == KeyEvent.VK_E ? new ControlCenter22ComeBack() : this;
	}
}