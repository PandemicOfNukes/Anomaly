...
public class Corridor13Left implements Screen {
	...
	public void displayOutput(AsciiPanel terminal) {
		...
		terminal.write("You see bloody hand imprints in the walls...",1,5);
	...
	public Screen respondToUserInput(KeyEvent key) {
		return key.getKeyCode() == KeyEvent.VK_Q ? new Corridor13ComeBack() : this;
	}
