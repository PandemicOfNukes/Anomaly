...
public class LoseScreen3 implements Screen {
	...
	public LoseScreen3(Creature player){
		this.player = player;
	}
	...
	public Screen respondToUserInput(KeyEvent key) {
		if(PlayScreen3.death == 6) {
			return key.getKeyCode() == KeyEvent.VK_ENTER ? new Room13() : this;
		} else
			return key.getKeyCode() == KeyEvent.VK_ENTER ? new PlayScreen3() : this;
	}
}
