...
public class LoseScreen4 implements Screen {
	private Creature player;
	
	public LoseScreen4(Creature player){
		this.player = player;
	}
	...
	public Screen respondToUserInput(KeyEvent key) {
		if(PlayScreen4.death == 6) {
			return key.getKeyCode() == KeyEvent.VK_ENTER ? new Room14() : this;
		} else
			return key.getKeyCode() == KeyEvent.VK_ENTER ? new PlayScreen4() : this;
	}
}
