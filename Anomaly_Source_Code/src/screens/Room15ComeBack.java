...
public class Room15ComeBack implements Screen {
	...
	public Screen respondToUserInput(KeyEvent key) {
		...
		case KeyEvent.VK_Q:
			return key.getKeyCode() == KeyEvent.VK_Q ? new Room15Writting() : this;
		case KeyEvent.VK_W:
			return key.getKeyCode() == KeyEvent.VK_W ? new ExaminateToiletRoom15() : this;
		case KeyEvent.VK_E:
			return key.getKeyCode() == KeyEvent.VK_E ? new StrangeDeviceRoom15() : this;
	}
		return key.getKeyCode() == KeyEvent.VK_R ? new ControlCenter15() : this;
	}
