...
public class Corridor1ComeBack implements Screen {
	...
	public Screen respondToUserInput(KeyEvent key) {
		...
		case KeyEvent.VK_Q:
			return key.getKeyCode() == KeyEvent.VK_Q ? new Corridor1Left() : this;
		case KeyEvent.VK_W:
			return key.getKeyCode() == KeyEvent.VK_W ? new Corridor1Right() : this;
		case KeyEvent.VK_E:
			return key.getKeyCode() == KeyEvent.VK_E ? new Cafeteria1() : this;	
		}
		return key.getKeyCode() == KeyEvent.VK_R ? new ControlCenter1ComeBack() : this;	
	}
}
