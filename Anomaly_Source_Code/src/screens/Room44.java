...
public class Room44 implements Screen {
	@Override
	...
	public Screen respondToUserInput(KeyEvent key) {
		switch(key.getKeyCode()) {
			case KeyEvent.VK_Q:
				return key.getKeyCode() == KeyEvent.VK_Q ? new ExaminateToiletRoom44() : this;
			case KeyEvent.VK_W:
				return key.getKeyCode() == KeyEvent.VK_W ? new StrangeDeviceRoom44() : this;
		}
			return key.getKeyCode() == KeyEvent.VK_E ? new ControlCenter24ComeBack() : this;
	}
}