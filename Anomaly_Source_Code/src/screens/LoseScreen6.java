...
public class LoseScreen6 implements Screen {
	private Creature player;
	
	public LoseScreen6(Creature player){
		this.player = player;
	}
	...
	public Screen respondToUserInput(KeyEvent key) {
		if(PlayScreen6.death == 6) {
			return key.getKeyCode() == KeyEvent.VK_ENTER ? new Room16() : this;
		} else
